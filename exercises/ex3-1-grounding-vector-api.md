...
TODO: add multimodal file types above?
...
TODO: I would move the COLLECTION_ID instruction further up, right after we copy the collection id from Bruno - to avoid
copying it twice.
